...
const ITEMS = [
  {
    id: "linkedin", label: "LINKEDIN", handle: "@yourname", href: "https://www.linkedin.com/in/mattéo-begue-921a7b384/", icon: "", barIcon: icon1, bars: 1, newBars: [0], counts: ["426"],
    links: ["https://www.linkedin.com/feed/update/urn:li:activity:7386778390068006912/?originTrackingId=4k0bqMNYAyRG%2FwHULV7YnQ%3D%3D"],
    stats: [
      { tag: "FOL", value: "30", color: "#4763ff" },
      { tag: "PST", value: "1",  color: "#94b0ff" },
    ],
  },
  {
    id: "instagram", label: "INSTAGRAM", handle: "@yourhandle", href: "https://instagram.com/rapoutoutou", icon: "", barIcon: icon2, bars: 1, newBars: [1, 2], counts: ["34"],
    links: ["instagram.com/p/DKDd_iCtFWNoeKdqbJTSHXHqPuXIsyRL5M0P640/?img_index=1"],
    stats: [
      { tag: "FOL", value: "119", color: "#e1306c" },
      { tag: "PST", value: "1",  color: "#f77737" },
    ],
  },
];
