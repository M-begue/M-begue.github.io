...
const REVEAL_CONTENT = [
  {
    upper: ["BEGUE Mattéo", "Étude : BUT Informatique à Limoges (2ème année)"],
    lower: "Développeur junior",
  },
  {
    upper: [  
...
const ITEMS = [
  {
    id: "twitch", label: "À PROPOS DE MOI", handle: "@yourname", href: "https://twitch.tv/yourname", icon: "🎮", barIcon: icon1, bars: 1, newBars: [0], counts: ["56"],
  ...
  {
    id: "instagram", label: "FUN FACT", handle: "@yourhandle", href: "https://instagram.com/yourhandle", icon: "📷", barIcon: icon2, bars: 5, newBars: [1, 2], counts: ["3.4M", "2.5M", "676K", "412K", "198K"],
  ...
  {
    id: "tiktok", label: "BIZARRE FACT", handle: "@yourhandle", href: "https://tiktok.com/@yourhandle", icon: "🎵", barIcon: icon3, bars: 7, newBars: [0, 3, 5, 6], counts: ["5.1M", "3.7M", "2.2M", "1.4M", "831K", "490K", "217K"],
